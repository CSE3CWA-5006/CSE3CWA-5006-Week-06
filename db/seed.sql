...
VALUES
  ...
  ('Document Retention Service', 'Liam', 'complete', 'database', 'high', 100,
   'A records service for retention policies, document lifecycles and controlled archival workflows.', CURRENT_DATE - 3);

INSERT INTO app_seed_meta (seed_version)
VALUES ('2026-08-12-final-9-projects-v2')
